...
os.system('pip install torch pyttsx3')
os.system('cls' if os.name == 'nt' else 'clear')
os.system('color 0a')
print("APOLLO AI - A Conversational AI Model\n")
...
# Training data (expand as needed)
data = (
    "User: Hello\n"
...
def chat(prompt, max_len=200):
    ...
    for _ in range(max_len):
        ...
        output += next_char
        input_seq = torch.cat([input_seq, torch.tensor([[next_idx]])], dim=1)
        if output.endswith('\nUser:'):
            break
